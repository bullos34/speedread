  ...
  return (
    <div className="rounded-lg border border-dashed p-8 sm:p-12 text-center">
      <div className="max-w-md mx-auto">
        ...
        <h2 className="text-xl sm:text-2xl font-bold mb-2">Welcome to Speed-r</h2>
        <p className="text-sm sm:text-base text-muted-foreground mb-6">
          Get started by adding your first document. You can paste text, upload files (PDF, TXT, DOCX), or import articles from URLs.
        </p>
            ...
            <div className="space-y-4">
              ...
              {mode === "paste" ? (
                <div className="space-y-2">
                  <Label htmlFor="empty-paste-title">Title</Label>
                  <input
                    id="empty-paste-title"
                    type="text"
                    value={title}
                  ...
                  />
                  <Label htmlFor="empty-paste-text">Text</Label>
                  <textarea
                    id="empty-paste-text"
                    value={pastedText}
                ...
                <div className="space-y-2">
                  <Label htmlFor="empty-upload-title">Title (optional)</Label>
                  <input
                    id="empty-upload-title"
                    type="text"
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    ...
                    className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  />
                  <Label htmlFor="empty-upload-file">File (PDF, TXT, DOCX)</Label>
                  <input
                    id="empty-upload-file"
                    type="file"
                    accept=".pdf,.txt,.docx"
                    onChange={(e) => {
                ...
                <div className="space-y-2">
                  <Label htmlFor="empty-url-title">Title (optional)</Label>
                  <input
                    id="empty-url-title"
                    type="text"
                    value={title}
                    ...
                    className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  />
                  <Label htmlFor="empty-url">Article URL</Label>
                  <input
                    id="empty-url"
                    type="url"
                    value={url}
